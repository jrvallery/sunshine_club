...
def _citation_from_payload(payload: dict[str, Any], metadata: dict[str, Any], score: Any) -> dict[str, Any]:
    return {
        ...
        "run_key": _payload_value(payload, metadata, "run_key"),
        "content_class": _payload_value(payload, metadata, "content_class"),
        "primary_tag": _payload_value(payload, metadata, "primary_tag"),
        "route_status": _payload_value(payload, metadata, "route_status"),
        "review_status": _payload_value(payload, metadata, "review_status"),
