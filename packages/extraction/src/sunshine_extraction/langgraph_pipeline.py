...
The CLI implementation now lives under ``sunshine_extraction.cli`` and the graph
runtime lives under ``sunshine_extraction.graph``. This module keeps existing
imports and ``python -m sunshine_extraction.langgraph_pipeline`` working.
"""

from sunshine_extraction.cli.langgraph_pipeline import main
