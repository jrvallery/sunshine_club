...
def main() -> None:
    ...
    parser.add_argument("--sample-max-megabytes", type=float, help="Optional maximum file size per manifest sample after category filtering.")
    ...
    result = benchmark_extraction_providers(
        ...
        sample_max_megabytes=args.sample_max_megabytes,
